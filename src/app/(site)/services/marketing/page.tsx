 ...
 * — Always-dark neon theme (matches Design page)
 * — Full-bleed smooth backdrop (NeonBackdrop + Aurora, no grid)
 * — Glassy surfaces + Framer Motion v11 tuple easings
 */

// Easing (tuples) — type-safe for FM v11+
...
const CASES = [
  { tag: "D2C",   title: "Scaled to 4.3× ROAS in 60 days", metric: "+83% revenue", icon: Rocket },
...
export default function MarketingPage() {
  return (
    <div className="relative min-h-screen text-white">
      <NeonBackdrop />     {/* full-bleed, fixed; no grid/check */}
          ...
          <div className="mx-auto max-w-7xl px-6 py-10 md:py-16">
            <div className="grid gap-8 lg:grid-cols-2">
              <motion.div {...fadeUp(0)} className="glassy-card rounded-2xl p-6">
                ...
                <blockquote className="mt-4 text-balance text-lg text-white/80">
                ...
                <p className="mt-4 text-sm text-white/70">— VP Growth, B2C Subscription</p>
              </motion.div>
...
/* Full-bleed neon background (no grid/check pattern) — same as Design page */
